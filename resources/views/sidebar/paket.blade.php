    ...
    <h1 class="heading"> MGC <span>Menyediakan Barang dan Jasa</span> </h1>
                ...
                <div class="row">
                    <div class="col-md-4 nb-3">
                        <div class="card">
                            <img src="{{asset('images/seperangkatcomputer.jpg')}}" class="card-img-top" alt="paket1" height="200" width="300">
                            <div class="card-body">
                    ...
                    <div class="col-md-4 nb-3">
                        <div class="card">
                            <img src="{{asset('images/tplink.jpg')}}" class="card-img-top" alt="paket1"  height="200" width="300">
                            <div class="card-body">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            <img src="{{asset('images/TEKNISI1.webp')}}" class="card-img-top" alt="paket1"  height="200" width="300">
                            <div class="card-body">
