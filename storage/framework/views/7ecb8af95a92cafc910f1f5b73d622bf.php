...
<section class="about us" id="about us">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="user">
                <img src="<?php echo e(asset('images/OWNER2.jpg')); ?>" alt="">
                <div class="user-info">
                    <h3>IRANI</h3>
                </div>
            </div>
        ...
        <div class="box">
            ...
            <div class="user">
                <img src="<?php echo e(asset('images/MANAGER.png')); ?>" alt="">
                <div class="user-info">
                    <h3>SUTOPO</h3>
                </div>
            </div>
        ...
        <div class="box">
            ...
            <div class="user">
                <img src="<?php echo e(asset('images/ADMINISTRASI.jpg')); ?>" alt="">
                <div class="user-info">
                    <h3>ANNISA</h3>
                </div>
            </div>
        ...
        <div class="box">
            ...
            <div class="user">
                <img src="<?php echo e(asset('images/TEKNISI1.webp')); ?>" alt="">
                <div class="user-info">
                    <h3>FAHRI</h3>
                </div>
            </div>
        ...
        <div class="box">
            <p> 	Teknisi : Teknisi Komputer bertugas dan bertanggung jawab untuk melaksanakan, mengelola, mengembangkan, dan memperbaiki perangkat keras dan lunak untuk infrastruktur TIK agar dukungan layanan TIK di unit kerja lancar dan tersedia dengan baik.</p>
            <div class="user">
                <img src="<?php echo e(asset('images/TEKNISI2.jpg')); ?>" alt="">
                <div class="user-info">
                    <h3>AMRI</h3>
                </div>
            </div>
        ...
        <div class="box">
            <p> 	Teknisi : Teknisi Komputer bertugas dan bertanggung jawab untuk melaksanakan, mengelola, mengembangkan, dan memperbaiki perangkat keras dan lunak untuk infrastruktur TIK agar dukungan layanan TIK di unit kerja lancar dan tersedia dengan baik.</p>
            <div class="user">
                <img src="<?php echo e(asset('images/TEKNISI3.jpg')); ?>" alt="">
                <div class="user-info">
                    <h3>JAY</h3>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\project-toko\resources\views/sidebar/aboutus.blade.php ENDPATH**/ ?>